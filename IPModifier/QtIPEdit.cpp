...
QtIPEdit::QtIPEdit(QWidget* parent) : QWidget(parent)
{
	bgColor = "#FFFFFF";
	borderColor = "#A6B5B8";
	borderRadius = 3;
...
bool QtIPEdit::eventFilter(QObject* watched, QEvent* event)
{
...
void QtIPEdit::textChanged(const QString& text)
{
	int len = text.length();
...
QString QtIPEdit::getIP() const
{
	return this->ip;
}

QSize QtIPEdit::sizeHint() const
{
	return QSize(250, 20);
}

QSize QtIPEdit::minimumSizeHint() const
{
	return QSize(30, 10);
}

void QtIPEdit::setIP(const QString& ip)
{
	//先检测IP地址是否合法
...
void QtIPEdit::setBgColor(const QString& bgColor)
{
...
void QtIPEdit::setBorderColor(const QString& borderColor)
{
...
void QtIPEdit::setBorderRadius(int borderRadius)
{
