...
#ifndef _QT_IP_EDIT_H_
#define _QT_IP_EDIT_H_
#include <QWidget>
...
class QDESIGNER_WIDGET_EXPORT QtIPEdit : public QWidget
#else


class QtIPEdit : public QWidget
#endif
...
public:
    explicit QtIPEdit(QWidget* parent = 0);
